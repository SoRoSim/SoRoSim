function [Res, Jac_q, Jac_u, Jac_l] = StaticResidueJacobian(Linkage, q, u, lambda)
    N = Linkage.N;
    ndof = Linkage.ndof;
    nsig = Linkage.nsig;
    nj = Linkage.nj;
    ...
    % n_k = Linkage.ActiationPrecompute.n_K;
    Res = [taumID; e];
    Jac_q = [dtaumID_dq; de_dq];
    Jac_u = [B; zeros(nCLp,n_k)];
    Jac_l = [A'; zeros(nCLp, nCLp)]; %should be zeros(6, nCLp)
end