function [tau, F, e, dtau_dq, dtau_du, dF_dq, dF_dlambda, de_dq] = StaticJacobians(Linkage, q, u, lambda)
%% Returns all terms of the static equation and all the combinations of its jacobians
