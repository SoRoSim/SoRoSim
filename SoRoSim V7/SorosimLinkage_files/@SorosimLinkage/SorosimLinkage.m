        ...
        function Linkage = SorosimLinkage(varargin)
            if strcmp(varargin{1},'empty')
                ...
                if nCLj>0
                    ...
                    %     nCLp = nCLp+size(Phi_p{iCLj},2); % can pre compute
                    % end
                    Linkage.CLprecompute.Phi_p  = Phi_p; %Perpendicular basis of the closed loop joint
                    % Linkage.CLprecompute.nCLp   = nCLp; % ndof of Bp
...
%% Miscellaneous precomputations
                ...
                %Precomputations for closed chain constraints (depends on Fp_loc)
                ...
                switch Answer
                    ...
                    case 'Yes'
                        ...
                        [n_jact,i_jact,i_jactq,WrenchControlled,Bqj1] = JointActuation(Linkage,false);
        ...
        [q,u]   = statics(S,qu0,magnifier)            %for static simulation
    ...
    methods % Property Update functions
        ...
        function Linkage = Update(Linkage)
            ...
            [Linkage.nsig,Linkage.nj] = find_nsig_nj(Linkage);
            [~,~,i_jactq_new,~,Bqj1_new] = JointActuation(Linkage,true);
            Linkage.i_jactq = i_jactq_new;
            Linkage.Bqj1    = Bqj1_new;
