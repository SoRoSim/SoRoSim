...
T1 = [eye(3) [(constraint_surface.hole_1(1) + constraint_surface.hole_2(1))/2; (constraint_surface.hole_1(2)+constraint_surface.hole_2(2))/2; (constraint_surface.hole_1(3) + constraint_surface.hole_2(3))/2]; [0 0 0 1]];
T2 = [eye(3) -[(constraint_surface.hole_1(1) + constraint_surface.hole_2(1))/2; (constraint_surface.hole_1(2)+constraint_surface.hole_2(2))/2; (constraint_surface.hole_1(3) + constraint_surface.hole_2(3))/2]; [0 0 0 1]];
...
% qu_uq_l0 = zeros(80,1);
qu_uq_l0 = [qu_uq_l_final1; 0.5; 0.5];
...
options = optimoptions('fmincon','Display','iter','OptimalityTolerance',1e-8,'StepTolerance',1e-8 ,'MaxFunctionEvaluations',2e10,'Algorithm','sqp','SpecifyObjectiveGradient',true,'SpecifyConstraintGradient',true);%EnableFeasibilityMode',true);%,'OptimalityTolerance',1e-10,'StepTolerance',1e-20);
% lambda = 5e3;
