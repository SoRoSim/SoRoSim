function qdqdd = derivatives2(Linkage,t,qqd,dynamicAction,GUI_actionInput,dynamicsOptions) %u is a function of t
    ...
    y = dynamicsSolver2(Linkage,t,[q;qd],action); %solves for x = [qdd_u; u_u; lambda], for a given t, q, qd, and action
    qdd = y(1:ndof);
