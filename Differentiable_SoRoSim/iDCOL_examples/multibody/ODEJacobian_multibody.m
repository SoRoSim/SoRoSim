function dxd_dx = ODEJacobian_multibody(Linkage,t,x,dynamicAction,GUI_actionInput)
    ...
    [y,C,B_action,action,z_star,J_f] = dynamicsSolver_multibody(Linkage,t,[q;qd],action); %solves for x = [qdd_u; u_u; lambda], for a given t, q, qd, and action
    qdd = y(1:ndof);
    u   = action;
    lambda = y(ndof+1:end);
    ...
    [dID_dq,dID_dqd,dtau_dq,dtau_dqd,de_dq,de_dqd,daction_dq,daction_dqd] = DAEi1Jacobians_qqd_multibody(Linkage,t,q,qd,qdd,u,lambda,z_star,J_f);
