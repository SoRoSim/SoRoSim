function [ID,tau,dID_dq,dID_dqd,dID_dqdd,dtau_dq,dtau_dqd,dtau_du,g,J] = dRNEA(Linkage,t,q,qd,qdd,u)

persistent ID_last tau_last dID_dq_last dID_dqd_last dID_dqdd_last dtau_dq_last dtau_dqd_last dtau_du_last g_last J_last
...
if ischar(Linkage) || (isstring(Linkage) && isscalar(Linkage))
    if strcmpi(string(Linkage),"getlast")
        ...
        tau = tau_last;
        dID_dq = dID_dq_last;
        dID_dqd = dID_dqd_last;
        dID_dqdd = dID_dqdd_last;
        dtau_dq = dtau_dq_last;
        dtau_dqd = dtau_dqd_last;
        dtau_du = dtau_du_last;
...
tau_last    = tau;
dID_dq_last = dID_dq;
dID_dqd_last = dID_dqd;
dID_dqdd_last = dID_dqdd;
dtau_dq_last = dtau_dq;
dtau_dqd_last = dtau_dqd;
dtau_du_last = dtau_du;
